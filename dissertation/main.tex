...
%add-on for nomencatur generation (AbkÃ¼rzungsvwerzeichnis!)
%\usepackage{nomencl}
...
%	    unicode=false,          % non-Latin characters in Acrobatï¿½s bookmarks
	    pdftoolbar=true,        % show Acrobatï¿½s toolbar?
	    pdfmenubar=true,        % show Acrobatï¿½s menu?
...
\input{chapter/literature_review/literature_review.tex}
\chapter{Theoretical Framework: Fundamental concepts and tools}
