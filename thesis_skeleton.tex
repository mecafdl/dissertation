...
%\begin{itemize}
%	\item Robots learning models of their bodies have diverse implications. Among them, increased bodily awareness that yields higher autonomy. Better locomotion strategies and motion planning. Enhanced dexterous object manipulation leading to effective tool usage. Heightened bodily awareness and motor control leads to improved interaction with energy and safety guarantees. Safer human-robot interaction.
%
%	\item The ability for robots to learn models of their bodies is inspired by the concepts of the physical self, the ecological self, and body schema in humans, aiming to emulate aspects of human cognition and adaptability.
%
